                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex justify-center gap-3 items-center flex-wrap">
                                        ...
                                        <form action="{{ route('reservations.destroy', $reservation->id) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button class="w-8 h-8 rounded-full bg-red-50 flex items-center justify-center text-red-600 hover:bg-red-600 hover:text-white transition border border-red-100 hover:border-red-600"
                                                title="حذف نهائي"
